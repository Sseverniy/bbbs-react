      ...
      <>
        <div className='calendar__caption'>
          ...
          <div className='calendar__about'>
            <h2 className='section-title calendar__title calendar__title_type_popup'>{event1.title}</h2>
        ...
        <div className='calendar__meetup'>
          ...
          <div className='calendar__description'>
            <p className='paragraph calendar__desc-paragraph'>{event1.description}</p>
          </div>
